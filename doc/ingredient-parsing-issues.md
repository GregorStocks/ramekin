...
- [ ] **Trailing comma before parenthetical note** (~711 fixtures) - "1 sweet onion, (diced)" produces item="sweet onion," with a trailing comma. The comma before the parenthetical note should be stripped from the item name. Examples: `3 oz. pancetta, (diced into 1/4-inch pieces)` → item="pancetta,", `2 shallots, (thinly sliced)` → item="shallots,", `1 garlic clove, (finely minced)` → item="garlic clove,".

...
class PhotosApi:
    ...
    def get_photo(
        self,
        id: Annotated[StrictStr, Field(description="Photo ID")],
    ...
    def list_photos(
        ...
        _param = self._list_photos_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def list_photos_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_photos_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],

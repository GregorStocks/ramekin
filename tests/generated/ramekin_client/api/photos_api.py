...
class PhotosApi:
    ...
    def get_photo_thumbnail(
        self,
        id: Annotated[UUID, Field(description="Photo ID")],
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Desired thumbnail size in pixels (longest edge). Clamped to 1..=800. Default: 200.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[

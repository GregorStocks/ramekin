...
class RecipesApi:
    ...
    def estimate_calories(
        self,
        estimate_calories_request: EstimateCaloriesRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param estimate_calories_request: (required)
        :type estimate_calories_request: EstimateCaloriesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._estimate_calories_serialize(
            estimate_calories_request=estimate_calories_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def estimate_calories_with_http_info(
        self,
        estimate_calories_request: EstimateCaloriesRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CalorieEstimateResponse]:
        """estimate_calories
    ...
    @validate_call
    def estimate_calories_without_preload_content(
        self,
        estimate_calories_request: EstimateCaloriesRequest,
        _request_timeout: Union[
            None,
    ...
    def _estimate_calories_serialize(
        self,
        estimate_calories_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if estimate_calories_request is not None:
            _body_params = estimate_calories_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/recipes/estimate-calories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _generate_description_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/recipes/{id}/generate-description',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def generate_photo(
        ...
        _param = self._generate_photo_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def generate_photo_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Recipe ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GeneratePhotoResponse]:
        """generate_photo
    ...
    @validate_call
    def generate_photo_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Recipe ID")],
        _request_timeout: Union[
            None,
    ...
    def _generate_photo_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/recipes/{id}/generate-photo',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def normalize_title(
        ...
        _param = self._normalize_title_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def normalize_title_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Recipe ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NormalizeTitleResponse]:
        """normalize_title
    ...
    @validate_call
    def normalize_title_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Recipe ID")],
        _request_timeout: Union[
            None,
    ...
    def _normalize_title_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/recipes/{id}/normalize-title',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rescrape_photo(
        ...
        _param = self._rescrape_photo_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def rescrape_photo_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Recipe ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def rescrape_photo_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Recipe ID")],
        _request_timeout: Union[
            None,
    ...
    def _rescrape_photo_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/recipes/{id}/rescrape-photo',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def sync_recipes_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SyncRecipesResponse]:
        """sync_recipes
    ...
    def _sync_recipes_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/recipes/sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

# ramekin_client.AuthhandlersApi
...
with ramekin_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AuthhandlersApi->ping:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthhandlersApi->ping: %s\n" % e)
```
...
with ramekin_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AuthhandlersApi->signup:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthhandlersApi->signup: %s\n" % e)
```

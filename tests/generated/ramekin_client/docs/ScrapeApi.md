...
with ramekin_client.ApiClient(configuration) as api_client:
    ...
    capture_request = ramekin_client.CaptureRequest() # CaptureRequest | 

    try:
        api_response = api_instance.capture(capture_request)
        print("The response of ScrapeApi->capture:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ScrapeApi->capture: %s\n" % e)
```
...
# **get_step_output**
> object get_step_output(id, step_name)
...
with ramekin_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ramekin_client.ScrapeApi(api_client)
    id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Scrape job ID
    step_name = 'step_name_example' # str | Pipeline step name

    try:
        api_response = api_instance.get_step_output(id, step_name)
        print("The response of ScrapeApi->get_step_output:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ScrapeApi->get_step_output: %s\n" % e)
```

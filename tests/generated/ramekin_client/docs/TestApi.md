# ramekin_client.TestApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**ping**](TestApi.md#ping) | **GET** /api/test/ping | 
[**unauthed_ping**](TestApi.md#unauthed_ping) | **GET** /api/test/unauthed-ping | 
...
with ramekin_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ramekin_client.TestApi(api_client)
...
with ramekin_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TestApi->unauthed_ping:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TestApi->unauthed_ping: %s\n" % e)
```

...
# **list_photos**
> ListPhotosResponse list_photos()
...
with ramekin_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list_photos()
        print("The response of PhotosApi->list_photos:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PhotosApi->list_photos: %s\n" % e)
```

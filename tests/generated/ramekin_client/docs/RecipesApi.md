...
# **estimate_calories**
> CalorieEstimateResponse estimate_calories(estimate_calories_request)
...
with ramekin_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ramekin_client.RecipesApi(api_client)
    estimate_calories_request = ramekin_client.EstimateCaloriesRequest() # EstimateCaloriesRequest | 

    try:
        api_response = api_instance.estimate_calories(estimate_calories_request)
        print("The response of RecipesApi->estimate_calories:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RecipesApi->estimate_calories: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **estimate_calories_request** | [**EstimateCaloriesRequest**](EstimateCaloriesRequest.md)|  | 

...
from ramekin_client.api_response import ApiResponse, T as ApiResponseT
import ramekin_client.models
from ramekin_client import rest
from ramekin_client.exceptions import (
    ApiValueError,
    ApiException,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ramekin_client.models, klass)

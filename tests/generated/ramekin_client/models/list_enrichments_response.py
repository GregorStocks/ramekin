...
class ListEnrichmentsResponse(BaseModel):
    ...
    """ # noqa: E501
    enrichments: List[EnrichmentInfo] = Field(description="Available enrichment types.")
    __properties: ClassVar[List[str]] = ["enrichments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "enrichments": [EnrichmentInfo.from_dict(_item) for _item in obj["enrichments"]] if obj.get("enrichments") is not None else None
        })
        return _obj

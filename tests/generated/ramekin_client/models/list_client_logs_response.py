...
class ListClientLogsResponse(BaseModel):
    """
    ListClientLogsResponse
    """ # noqa: E501
    uploads: List[ClientLogSummary]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uploads": [ClientLogSummary.from_dict(_item) for _item in obj["uploads"]] if obj.get("uploads") is not None else None
        })
        return _obj

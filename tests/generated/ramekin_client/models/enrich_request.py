...
class EnrichRequest(BaseModel):
    ...
    """ # noqa: E501
    enrichment_type: StrictStr = Field(description="The type of enrichment to apply (e.g., \"normalize_ingredients\").")
    recipe: RecipeContent = Field(description="The recipe content to enrich.")
    __properties: ClassVar[List[str]] = ["enrichment_type", "recipe"]

...
class EnrichResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cook_time", "description", "difficulty", "ingredients", "instructions", "notes", "nutritional_info", "prep_time", "rating", "servings", "source_name", "source_url", "tags", "title", "total_time"]

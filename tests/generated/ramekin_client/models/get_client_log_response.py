...
class GetClientLogResponse(BaseModel):
    """
    ...
    created_at: datetime
    id: UUID
    os_info: Optional[StrictStr] = None
    platform: StrictStr
    __properties: ClassVar[List[str]] = ["app_version", "content", "created_at", "id", "os_info", "platform"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if os_info (nullable) is None
        # and model_fields_set contains the field
        if self.os_info is None and "os_info" in self.model_fields_set:
            _dict['os_info'] = None

...
class BookmarkletTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    token: StrictStr = Field(description="A freshly minted, long-lived token scoped to the capture endpoints. Embed it in the bookmarklet; it does not expire and does not invalidate previously minted bookmarklet tokens.")

...
> models::GenerateDescriptionResponse generate_description(id)
...
[**models::GenerateDescriptionResponse**](GenerateDescriptionResponse.md)
...
> models::RescrapeResponse rescrape_photo(id)
